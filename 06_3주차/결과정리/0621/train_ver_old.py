...
for trial in range(num_trials):
    ...
    if avg_loss <= tmp :
        # 모델 저장
        tmp = avg_loss
        torch.save(model.state_dict(), "./model/mutli-module_based_cvae_standard_Best.pth")
        print("최고 모델 저장 완료!")
...
# 모델 저장
torch.save(model.state_dict(), "./model/mutli-module_based_cvae_best_ver_standard_backup.pth")
