...
pretrain_model.load_state_dict(torch.load('./model/0820/pretrained_all_waves_lr_schedueling.pth'))

# 사전학습 모델에서 디코더 모델 불러오기
state_dict = (torch.load('./model/0820/pretrained_all_waves_lr_schedueling.pth'))
...
class Valid_model_Normal(nn.Module):
    ...
    def forward(self, x, c):
        self.encoder.load_state_dict(torch.load('./model/0820/adaptation_all_waves_lr_scheduel.pth'))
