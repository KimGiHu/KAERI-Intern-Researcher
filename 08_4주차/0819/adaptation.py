...
source_model.load_state_dict(torch.load('./model/0814/pretrained_all_waves_lr_schedueling.pth'))
...
if __name__ =='__main__':
    ...
    torch.save(target_encoder.state_dict(), "./model/0819/adaptation_all_waves.pth")
