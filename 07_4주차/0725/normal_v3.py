...
if __name__ =='__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for (source_x,source_label), (target_x, target_label) in zip(dataloader_source, dataloader_target):
            ...
            loss_discriminator = (nn.BCELoss()(discriminator(source_mu), source_mu_labels) + \
            ...
            loss_target = nn.BCELoss()(discriminator(target_mu), torch.ones(target_mu.size(0), 1).to(device)) + \
    ...
    torch.save(target_encoder.state_dict(), "./model/target_encoder_extended_normal_ver3.pth")
