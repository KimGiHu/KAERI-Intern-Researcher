...
data_test = Xnormal_RFQ[524-1:524,:,:] # visualize할 정상신호
...
# 학습한 모델 불러오기
model.load_state_dict(torch.load('./model/CVAE_0626_RFQ.pth'))
...
for i in range(len(features)):
    ...
    plt.savefig('./figure/0626/normal_RFQ_524th/' + str(features[i]) + '.png', dpi=600)
