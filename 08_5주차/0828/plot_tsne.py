...
baseline_model.load_state_dict(torch.load('./model/0826/baseline_reduction_mean.pth'))
...
proposed_model.load_state_dict(torch.load('./model/0826/proposed_activation_gelu_reduction_mean.pth'))
...
with torch.no_grad():
    ...
    for data_test, labels in pbar:
        ...
        # to append the normal mu, logvar and latent space z on baseline model
...
with torch.no_grad():
    ...
    for data_anomaly,anomaly_labels in pbar:
        ...
        # to append the abnormal mu, logvar and latent space z on baseline model
        ...
        # to append the abnormal mu, logvar and latent space z on proposed model
...
elif args.fault == 'Proposed Model' :
...
plt.legend()
plt.grid(True)
plt.savefig('./figure/0828/tsne/%s'%args.fault+' tsne_latent_space.png', dpi=600)
