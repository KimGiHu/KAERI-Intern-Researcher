...
# 출력
print(f'%s Precision: {precision:.4f}'%args.fault)
print(f'%s Recall: {recall:.4f}'%args.fault)
print(f'%s F1-score: {f1:.4f}'%args.fault)

# 혼동 행렬 출력
conf_matrix = confusion_matrix(true_labels, predicted_labels)
print('%s Confusion Matrix:'%args.fault)
print(conf_matrix)
...
plt.savefig('./figure/0827/roc/' +'%s'%args.fault + str(' Normal vs. Fault ROC Curve') + '.png', dpi=600)
