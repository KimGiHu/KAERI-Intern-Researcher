...
# train = min_max_scaler.fit_transform(Xanomaly_append.reshape(-1,1))
train = Xanomaly_append.flatten()

print(train[-int((4500/2)/2):].reshape(-1,1).shape)
...
torch.save(model, './model/lstm_scaler_3000_exp_window_hidden_16_append_ver2.h5')

model_load = torch.load('./model/lstm_scaler_3000_exp_window_hidden_16_append_ver2.h5')
