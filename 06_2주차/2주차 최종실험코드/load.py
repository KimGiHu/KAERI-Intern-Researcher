...
# 학습한 모델 불러오기
model.load_state_dict(torch.load('./model/mutli-module_based_cvae_best1.pth'))
...
for i in range(len(features)):
    ...
    if features[i] == 'DV/DT':
        features[i] = 'DV_DT'
    plt.savefig('./figure/CVAE_multi/normal_to_normal_test/' + str(features[i]) + '.png', dpi=600)